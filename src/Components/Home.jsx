  ...
  return (
    <div className='home'>
        ...
        <div className='bb'> 
            ...
            <a href="https://drive.google.com/file/d/1QkdwwIYJmVBC2A9V42nyR-o-E8BXCW3p/view?usp=drive_link" target='_blank'><button className='bu' style={{height:"52px"}}>My resume</button></a>
        </div>
           </div>
        </div>
  )
